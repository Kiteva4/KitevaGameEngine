...
*/
kge::vkstructs::UniformBuffer* KGEVkUniformBufferWorld::uniformBufferWorld()
{
    return &m_uniformBufferWorld;
}

KGEVkUniformBufferWorld::KGEVkUniformBufferWorld(const kge::vkstructs::Device* device):
    m_device{device}
{
